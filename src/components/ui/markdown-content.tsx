        ...
        React.useEffect(() => {
            const highlightCode = async () => {
                try {
                    ...
                    const highlightedJsx = tokens.map((line, lineIndex) => (
                    ...
                    setHighlighted(<code className="whitespace-pre-wrap">{highlightedJsx}</code>);

                } catch (error) {
                    console.error("Shiki highlighting failed:", error);
                    // In case of an error, just show the plain code
                    setHighlighted(
                        <code className="whitespace-pre-wrap">{children}</code>
                    );
                }
